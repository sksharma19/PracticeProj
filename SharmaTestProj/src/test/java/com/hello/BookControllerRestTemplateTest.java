...
import com.hello.BookRepository;
...
public class BookControllerRestTemplateTest {
    ...
    @Before
    public void init() {
        Book book = new Book(1L, "Book Name1", "Auth1", new BigDecimal("2.34"));
    ...
    public void find_bookId_OK() throws JSONException {
        ...
        String expected = "{id:1,name:\"Book Name1\",author:\"Auth1\",price:2.34}";
    ...
    public void find_allBook_OK() throws Exception {
        ...
        List<Book> books = Arrays.asList(
                new Book(1L, "Book Desc1", "Book3", new BigDecimal("6.59")),
                new Book(2L, "Book Desc2", "Book4", new BigDecimal("7.78")));
    ...
    public void update_book_OK() throws Exception {
        ...
        Book updateBook = new Book(1L, "Book6", "Auth2", new BigDecimal("8.91"));
